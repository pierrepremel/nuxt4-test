...
<template>
  <div>
    <UCard
      variant="soft"
      class="hover:shadow-lg transition-all duration-200 cursor-pointer px-0 h-full"
    >
      <template #header>
        <img
      ...
      <div class="">
        <div class="flex justify-between items-center">
          ...
          <div
            class="flex items-center text-sm font-semibold text-gray-600 mt-1"
          >
        ...
        <p class="text-gray-700 leading-relaxed line-clamp-3 text-sm mb-auto">
          {{ sale.description }}
        </p>
      </div>
